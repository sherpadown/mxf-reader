...
bin:
	# nuitka src/mxf_reader/__main__.py --output-filename=mxf-reader --remove-output --follow-imports --include-data-file=src/mxf_reader/database.json=database.json --mode=onefile
